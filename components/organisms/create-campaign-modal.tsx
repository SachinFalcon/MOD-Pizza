    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-sm md:max-w-2xl lg:max-w-5xl rounded-[1.5rem] shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-300 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-4 md:px-8 py-4 bg-white custom-scrollbar relative z-0">
          {currentStep === 1 && <StepBasics name={campaignName} setName={setCampaignName} />}
          {currentStep === 2 && (
            <StepTargeting 
              targeting={targeting} 
...
function StepBasics({ name, setName }: { name: string, setName: (val: string) => void }) {
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <select className="w-full bg-white border border-slate-200 rounded-lg py-2.5 px-4 text-sm font-medium text-slate-700 appearance-none focus:ring-2 focus:ring-[#991b1b]/20 focus:border-[#991b1b] transition-all outline-none pr-10">
              <option>Global - Locked</option>
            </select>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <select className="w-full bg-white border border-slate-200 rounded-lg py-2.5 px-4 text-sm font-medium text-slate-700 appearance-none focus:ring-2 focus:ring-[#991b1b]/20 focus:border-[#991b1b] transition-all outline-none pr-10">
              <option>Medium - Default priority</option>
            </select>
            <ChevronDown size={16} className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
          </div>
        </div>
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <div className="relative">
            <select 
              ...
              onChange={(e) => setTargeting({ ...targeting, region: e.target.value })}
              className="bg-white border border-slate-200 rounded-full py-2.5 pl-4 pr-8 text-sm font-medium text-slate-700 outline-none appearance-none"
            >
          ...
          <div className="relative">
            <select 
              ...
              onChange={(e) => setTargeting({ ...targeting, state: e.target.value })}
              className="bg-white border border-slate-200 rounded-full py-2.5 pl-4 pr-8 text-sm font-medium text-slate-700 outline-none appearance-none"
            >
              <option>State</option>
            </select>
          ...
          <div className="relative">
            <select 
              value={targeting.locality}
              onChange={(e) => setTargeting({ ...targeting, locality: e.target.value })}
              className="bg-white border border-slate-200 rounded-full py-2.5 pl-4 pr-8 text-sm font-medium text-slate-700 outline-none appearance-none"
            >
      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-slate-100">
            {/* North America Group */}
            <tr>
              <td colSpan={6} className="px-6 py-3 bg-slate-50/50 text-[11px] font-bold text-slate-600 tracking-widest">
                <div className="flex items-center gap-2">
                  <MapPin size={14} className="text-slate-400" />
                  NORTH AMERICA / FLAGSHIP NYC
                </div>
              </td>
            </tr>
            <TargetingRow id="OUT-1043-1" name="Hudson Yards Atrium" loc="New York City, NY" active screens="6 Screen" checked />
            <TargetingRow id="OUT-1043-2" name="Hudson Yards Atrium" loc="New York City, NY" active screens="6 Screen" checked />
            <TargetingRow id="OUT-1043-3" name="Hudson Yards Atrium" loc="New York City, NY" active screens="6 Screen" checked />
            
            {/* Europe Group */}
            <tr>
              <td colSpan={6} className="px-6 py-3 bg-slate-50/50 text-[11px] font-bold text-slate-600 tracking-widest border-t border-slate-100">
                <div className="flex items-center gap-2">
                  <MapPin size={14} className="text-slate-400" />
                  EUROPE / LONDON CENTRAL
                </div>
              </td>
            </tr>
            <TargetingRow id="OUT-1043-4" name="Hudson Yards Atrium" loc="New York City, NY" active={false} screens="6 Screen" checked={false} />
            <TargetingRow id="OUT-1043-5" name="Hudson Yards Atrium" loc="New York City, NY" active screens="6 Screen" checked={false} />
          </tbody>
        </table>
        
        {/* Pagination */}
        <div className="px-6 py-3 border-t border-slate-200 flex justify-between items-center text-[12px] font-medium text-slate-500">
          <div>Showing 1-10 of 142 Outlets</div>
            ...
            <div className="space-y-4">
               <div>
                 ...
                 <div className="flex gap-2 mt-2">
                   <span className="bg-emerald-50 text-emerald-600 text-[10px] font-bold uppercase tracking-widest px-2.5 py-0.5 rounded">GLOBAL</span>
                   <span className="bg-red-50 text-[#991b1b] text-[10px] font-bold uppercase tracking-widest px-2.5 py-0.5 rounded">HIGH PRIORITY</span>
                 </div>
               </div>
               ...
               <div className="grid grid-cols-2 pt-4 border-t border-slate-50">
                 <div>
                   ...
                   <p className="text-[13px] font-bold text-slate-900">Aug 1 - Aug 30</p>
                 </div>
                 <div>
                   <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest block mb-1">Duration</span>
                   <p className="text-[13px] font-bold text-slate-900">30 Days</p>
                 </div>
               </div>
            </div>
          </div>

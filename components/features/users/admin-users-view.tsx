...
// Mock Data
const rolesData = [
  { id: "0", name: "Administrator", desc: "Full system access", users: 12, permissions: 28, scope: "Global", status: "ACTIVE", icon: "shield" },
  { id: "1", name: "Campaign Manager", desc: "Create & manage campaigns", users: 12, permissions: 28, scope: "Regional", status: "ACTIVE", icon: "megaphone" },
  { id: "2", name: "Outlet Manager", desc: "Manage outlet screens", users: 12, permissions: 28, scope: "Outlet", status: "ACTIVE", icon: "store" },
  { id: "3", name: "Viewer", desc: "Read-only access", users: 12, permissions: 28, scope: "Global", status: "INACTIVE", icon: "eye" },
];
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-4 bg-white border border-slate-200 rounded-lg hover:border-modRed/30 hover:shadow-md transition-all cursor-pointer group">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-md bg-red-50 text-modRed flex items-center justify-center"><Store size={20} /></div>
                <div>
                  <div className="font-bold text-slate-900 group-hover:text-modRed transition-colors">Logistics Center North</div>
                  <div className="text-xs font-medium text-slate-500">Supply Chain Node • Sector 7</div>
                </div>
              </div>
              <ChevronRight size={20} className="text-slate-300 group-hover:text-modRed transition-colors" />
            </div>
            <div className="flex items-center justify-between p-4 bg-white border border-slate-200 rounded-lg hover:border-modRed/30 hover:shadow-md transition-all cursor-pointer group">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-md bg-red-50 text-modRed flex items-center justify-center"><Building2 size={20} /></div>
                <div>
                  <div className="font-bold text-slate-900 group-hover:text-modRed transition-colors">Branch Office 012</div>
                  <div className="text-xs font-medium text-slate-500">Downtown Corporate Suites</div>
                </div>
              </div>
              <ChevronRight size={20} className="text-slate-300 group-hover:text-modRed transition-colors" />
            </div>
        ...
        <div className="p-8 flex-1 overflow-y-auto space-y-8">
          <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" placeholder="e.g. Jane Doe" className="w-full px-4 py-3 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#B02A30] focus:ring-1 focus:ring-[#B02A30]" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-slate-900 mb-2">Phone Number</label>
                  <input type="text" placeholder="+1 (555) 000-0000" className="w-full px-4 py-3 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#B02A30] focus:ring-1 focus:ring-[#B02A30]" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-900 mb-2">Email Address</label>
                  <input type="email" placeholder="jane@company.com" className="w-full px-4 py-3 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#B02A30] focus:ring-1 focus:ring-[#B02A30]" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-bold text-slate-900 mb-2">Assign Role</label>
                <div className="relative">
                  <select className="w-full px-4 py-3 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-900 appearance-none focus:outline-none focus:border-[#B02A30] focus:ring-1 focus:ring-[#B02A30] cursor-pointer">
              ...
              <div className="bg-[#FCF5F6] border border-red-100 rounded-xl p-6">
                <h4 className="text-[15px] font-bold text-[#B02A30] mb-5">Permissions for Regional Manager</h4>
                <div className="grid grid-cols-2 gap-y-4">
                  <div className="flex items-center gap-3"><div className="w-5 h-5 rounded bg-[#B02A30] text-white flex items-center justify-center shadow-sm"><Check size={14} strokeWidth={3} /></div><span className="text-[13px] font-bold text-slate-900">View Dashboard</span></div>
                  <div className="flex items-center gap-3"><div className="w-5 h-5 rounded bg-[#B02A30] text-white flex items-center justify-center shadow-sm"><Check size={14} strokeWidth={3} /></div><span className="text-[13px] font-bold text-slate-900">Manage Users</span></div>
                  <div className="flex items-center gap-3"><div className="w-5 h-5 rounded bg-[#B02A30] text-white flex items-center justify-center shadow-sm"><Check size={14} strokeWidth={3} /></div><span className="text-[13px] font-bold text-slate-900">View Financial Reports</span></div>
                  <div className="flex items-center gap-3"><div className="w-5 h-5 rounded bg-white border border-slate-300 shadow-inner"></div><span className="text-[13px] font-medium text-slate-500">Edit System Settings</span></div>
                  <div className="flex items-center gap-3"><div className="w-5 h-5 rounded bg-white border border-slate-300 shadow-inner"></div><span className="text-[13px] font-medium text-slate-500">Delete Records</span></div>
                  <div className="flex items-center gap-3"><div className="w-5 h-5 rounded bg-[#B02A30] text-white flex items-center justify-center shadow-sm"><Check size={14} strokeWidth={3} /></div><span className="text-[13px] font-bold text-slate-900">Export Data</span></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-900 mb-4">Scope of Access</h3>
            <div>
              <label className="block text-sm font-bold text-slate-900 mb-2">Select Assigned Regions & Outlets</label>
              <div className="border border-slate-200 rounded-lg overflow-hidden bg-white shadow-sm">
                <div 
                  className="bg-[#FCF5F6] p-4 flex items-center justify-between cursor-pointer border-b border-red-100"
                  onClick={() => setScopeExpanded(!scopeExpanded)}
                >
                  <div className="flex items-center gap-3">
                    <div className="w-5 h-5 rounded bg-white border border-slate-300 shadow-inner"></div>
                    <span className="text-sm font-bold text-slate-900">West</span>
                  </div>
                  {scopeExpanded ? <ChevronUp size={20} className="text-slate-500" /> : <ChevronDown size={20} className="text-slate-500" />}
                </div>
                {scopeExpanded && (
                  <div className="bg-white p-4 space-y-4 pl-[52px]">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-5 h-5 rounded bg-white border border-slate-300 shadow-inner"></div>
                        <span className="text-sm font-medium text-slate-700">California</span>
                      </div>
                      <ChevronUp size={20} className="text-slate-500" />
                    </div>
                    <div className="pl-8 flex items-center justify-between cursor-pointer group" onClick={onOpenScope}>
                      <div className="flex items-center gap-3">
                        <div className="w-5 h-5 rounded bg-[#B02A30] text-white flex items-center justify-center shadow-sm"><Check size={14} strokeWidth={3} /></div>
                        <span className="text-[13px] font-bold text-slate-900 group-hover:text-[#B02A30] transition-colors">Outlet 402</span>
                      </div>
                    </div>
                  </div>
                )}
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-3xl rounded-xl shadow-2xl flex flex-col overflow-hidden relative slide-in-from-bottom-8 duration-300 max-h-[85vh]">
        ...
        <div className="p-6 flex-1 overflow-y-auto">
          ...
          <p className="text-sm font-bold text-slate-500 mb-4">12 total users</p>
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100">
              {[
                ...
                { name: "David Miller", email: "d.miller@mtashq.com", scope: "Global", status: "ACTIVE" },
              ].map((u, i) => (
        ...
        <div className="p-8 flex-1 overflow-y-auto space-y-8">
          <div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-bold text-slate-900 mb-2">Role Name</label>
                <input type="text" placeholder="e.g. Jane Doe" className="w-full px-4 py-3 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#B02A30] focus:ring-1 focus:ring-[#B02A30]" />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-900 mb-2">Add Base Template (Optional)</label>
                <div className="relative">
                  <select className="w-full px-4 py-3 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-700 appearance-none focus:outline-none focus:border-[#B02A30] focus:ring-1 focus:ring-[#B02A30] cursor-pointer">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-[#FCF5F6] border border-red-100 rounded-xl p-6">
                <h4 className="text-[15px] font-bold text-[#B02A30] mb-5">Page Access</h4>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] font-medium text-slate-900">Dashboard</span>
                    <div className="w-11 h-6 bg-[#B02A30] rounded-full relative cursor-pointer shadow-inner"><div className="w-5 h-5 bg-white rounded-full absolute right-0.5 top-0.5 shadow-sm"></div></div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] font-medium text-slate-700">Content Management</span>
                    <div className="w-11 h-6 bg-slate-200 rounded-full relative cursor-pointer shadow-inner"><div className="w-5 h-5 bg-white rounded-full absolute left-0.5 top-0.5 shadow-sm"></div></div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] font-medium text-slate-700">User Management</span>
                    <div className="w-11 h-6 bg-slate-200 rounded-full relative cursor-pointer shadow-inner"><div className="w-5 h-5 bg-white rounded-full absolute left-0.5 top-0.5 shadow-sm"></div></div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] font-medium text-slate-700">System Settings</span>
                    <div className="w-11 h-6 bg-slate-200 rounded-full relative cursor-pointer shadow-inner"><div className="w-5 h-5 bg-white rounded-full absolute left-0.5 top-0.5 shadow-sm"></div></div>
                  </div>
                </div>
              </div>
              <div className="bg-[#FCF5F6] border border-red-100 rounded-xl p-6">
                <h4 className="text-[15px] font-bold text-[#B02A30] mb-5">Action-level Permissions</h4>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] font-medium text-slate-700">Create Content</span>
                    <div className="w-11 h-6 bg-slate-200 rounded-full relative cursor-pointer shadow-inner"><div className="w-5 h-5 bg-white rounded-full absolute left-0.5 top-0.5 shadow-sm"></div></div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] font-medium text-slate-700">Edit Content</span>
                    <div className="w-11 h-6 bg-slate-200 rounded-full relative cursor-pointer shadow-inner"><div className="w-5 h-5 bg-white rounded-full absolute left-0.5 top-0.5 shadow-sm"></div></div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] font-medium text-slate-700">Publish Content</span>
                    <div className="w-11 h-6 bg-slate-200 rounded-full relative cursor-pointer shadow-inner"><div className="w-5 h-5 bg-white rounded-full absolute left-0.5 top-0.5 shadow-sm"></div></div>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] font-medium text-slate-700">Delete Records</span>
                    <div className="w-11 h-6 bg-slate-200 rounded-full relative cursor-pointer shadow-inner"><div className="w-5 h-5 bg-white rounded-full absolute left-0.5 top-0.5 shadow-sm"></div></div>
                  </div>
                </div>
              </div>
...
export function AdminUsersView() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-[1400px] mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row md:justify-between items-start md:items-end border-b border-slate-200 gap-4 md:gap-0">
        ...
        <div className="pb-3 w-full md:w-auto flex justify-end">
          <button 
            onClick={() => activeTab === "roles" ? setIsCreateRoleOpen(true) : setIsCreateUserOpen(true)}
            className="bg-modRed hover:bg-red-800 text-white text-sm font-bold py-2.5 px-5 rounded-md shadow-lg shadow-modRed/20 transition-all flex items-center justify-center gap-2 cursor-pointer w-full md:w-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-3">
          <button className="p-2 border border-slate-200 rounded-md bg-white hover:bg-slate-50 text-slate-500 transition-colors shrink-0">
            <Filter size={16} />
          </button>
          <CustomDropdown value="West Region" options={["West Region", "East Region"]} />
          <button 
            onClick={() => setIsAssignedScopeOpen(true)}
            className="flex items-center gap-2 bg-white border border-slate-200 rounded-md py-2 px-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors shrink-0"
          >
            Scope
            <ChevronDown size={14} className="text-slate-400" />
          </button>
        ...
        <div className="relative w-full md:w-auto">
          ...
          <input 
            type="text" 
            placeholder="Search...." 
            className="w-full md:w-[300px] pl-9 pr-4 py-2 border border-slate-200 rounded-md text-sm font-medium text-slate-700 bg-white focus:outline-none focus:ring-2 focus:ring-modRed/10 transition-all"
          />
        </div>
      </div>
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-red-50 flex items-center justify-center text-modRed">
                          {role.icon === "shield" && <Shield size={14} />}
                          {role.icon === "megaphone" && <Megaphone size={14} />}
                          {role.icon === "store" && <Store size={14} />}
                          {role.icon === "eye" && <Eye size={14} />}
                        </div>
                        <div>
                  ...
                  <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="w-full lg:w-[35%] space-y-6">
                      ...
                      <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm">
                        ...
                        <p className="text-[13px] font-medium text-slate-600 leading-relaxed">
                          The <strong className="text-slate-900">Publisher</strong> role is designed for content creators and managers. It allows users to manage digital assets, schedule deployments, and view analytics without full administrative system control.
                        </p>
                      </div>

                      {/* Effective Level */}
                      <div className="bg-[#FCF5F6] border border-red-100 rounded-lg p-6 shadow-sm">
                        <h3 className="text-[11px] font-black text-[#B02A30] uppercase tracking-widest mb-4">EFFECTIVE LEVEL</h3>
                        <div className="flex items-center justify-between mb-4">
                          <span className="text-sm font-semibold text-slate-800">Group Inherited</span>
                          <span className="bg-[#B02A30] text-white text-[10px] font-black px-2 py-0.5 rounded tracking-wider">LEVEL 3</span>
                        </div>
                        <p className="text-xs font-medium text-slate-500">Based on MTAS-HQ Publisher Policy v2.4</p>
                      </div>

                      {/* Active Overrides */}
                      <div className="bg-[#FFF9F0] border border-orange-100 rounded-lg p-5 shadow-sm flex gap-3">
                        <TriangleAlert size={18} className="text-[#A65B17] shrink-0 mt-0.5" />
                        <div>
                          <h3 className="text-sm font-bold text-[#A65B17] mb-1.5">Active Overrides</h3>
                          <p className="text-[12px] font-medium text-[#B86B1E] leading-relaxed">
                      ...
                      <div className="bg-[#FAFAFA] border border-slate-200 border-dashed rounded-lg p-6">
                        ...
                        <button className="w-full bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 text-xs font-bold py-2.5 rounded-md transition-colors shadow-sm flex items-center justify-center gap-2">
                    ...
                    <div className="w-full lg:w-[65%] space-y-6">
                      <div className="flex items-center justify-between px-1">
                        <h3 className="text-[15px] font-bold text-slate-900">Access Matrix</h3>
                        <div className="flex items-center gap-4 text-xs font-semibold">
                          <span className="flex items-center gap-1.5 text-slate-500"><div className="w-4 h-4 rounded-full bg-white border border-slate-100 shadow-sm text-[#137333] flex items-center justify-center"><Check size={10} strokeWidth={3} /></div> Granted</span>
                          <span className="flex items-center gap-1.5 text-slate-500"><div className="w-4 h-4 rounded-full bg-white border border-slate-100 shadow-sm text-[#B02A30] flex items-center justify-center"><X size={10} strokeWidth={3} /></div> Denied</span>
                        </div>
                      </div>
                      ...
                      <div className="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden">
                        <div className="px-6 pt-5 pb-4">
                          <h4 className="text-sm font-semibold text-slate-900">Layer 1: View & Navigation</h4>
                        </div>
                        ...
                        <div className="px-6 py-4 flex items-center justify-between">
                          ...
                          <div className="w-5 h-5 rounded-full bg-[#137333] text-white flex items-center justify-center"><Check size={12} strokeWidth={3} /></div>
                        </div>
                        
                        <div className="h-px bg-slate-100 mx-6"></div>
                        
                        {/* Row 2 (Override) */}
                        <div className="px-6 py-4 flex items-center justify-between bg-[#FFFCF5]">
                          <div>
                          ...
                          <div className="flex items-center gap-4">
                            <span className="text-[9px] font-bold text-[#A65B17] bg-[#FFF3CD] px-2 py-0.5 rounded tracking-widest">OVERRIDE</span>
                            <div className="w-5 h-5 rounded-full bg-[#B02A30] text-white flex items-center justify-center"><X size={12} strokeWidth={3} /></div>
                          </div>
                        </div>
                      ...
                      <div className="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden">
                        <div className="px-6 pt-5 pb-4">
                          <h4 className="text-sm font-semibold text-slate-900">Layer 2: Functional Actions</h4>
                        </div>
              ...
              {profileTab === "overview" && (
                <div className="flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto">
                  ...
                  <div className="w-full lg:w-[55%] space-y-6">
                    {/* General Information */}
                    <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm">
                      <h3 className="text-[15px] font-bold text-slate-900 mb-4">General Information</h3>
                      <div className="h-px w-full bg-slate-100 mb-4"></div>
                      <div className="grid grid-cols-2 gap-y-4">
                        <div>
                          <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Campaign</div>
                          <div className="text-[13px] font-bold text-slate-900">Marketing</div>
                        </div>
                        <div>
                          <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Location</div>
                          <div className="text-[13px] font-bold text-slate-900">New York, USA</div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-y-4">
                        ...
                        <div>
                          ...
                          <div className="text-[13px] font-bold text-slate-900">2 hours ago</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <button className="text-sm font-bold text-[#B02A30] hover:underline">Change Role</button>
                      </div>
                      <div className="h-px w-full bg-slate-100 mb-4"></div>
                      
                      <div className="bg-[#FCF5F6] border border-red-100 rounded-lg p-4 flex gap-4 mb-6">
                        <div className="w-10 h-10 rounded-md bg-[#B02A30] text-white flex items-center justify-center shrink-0">
                          <Shield size={20} />
                        </div>
                        <div>
                          <div className="text-[13px] font-bold text-slate-900 capitalize">Publisher</div>
                          <div className="text-[12px] font-medium text-slate-500 mt-0.5">Full access to content management and publishing tools.</div>
                        </div>
                      </div>

                      <div>
                        <h4 className="text-[13px] font-bold text-slate-900 mb-3">Effective Permissions</h4>
                        ...
                        <button className="text-[13px] font-medium text-slate-500 hover:text-slate-900 transition-colors">
                  ...
                  <div className="w-full lg:w-[45%] space-y-6">
                      ...
                      <div className="space-y-6">
                        <div>
                          ...
                          <div className="h-2.5 w-full bg-slate-100 rounded-full overflow-hidden">
                            <div className="h-full bg-[#1A73E8] rounded-full w-[85%]"></div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="h-2.5 w-full bg-slate-100 rounded-full overflow-hidden">
                            <div className="h-full bg-[#F29900] rounded-full w-[45%]"></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Latest Activity */}
                    <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm">
                      <h3 className="text-[15px] font-bold text-slate-900 mb-4">Latest Activity</h3>
                      <div className="h-px w-full bg-slate-100 mb-6"></div>
                      ...
                      <div className="relative pl-6 space-y-6 before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-[2px] before:bg-slate-100">
                        {/* Event 1 */}
                        <div className="relative">
                          <div className="absolute -left-[30px] top-0 w-6 h-6 rounded-full bg-[#E8F0FE] text-[#1A73E8] flex items-center justify-center ring-4 ring-white z-10">
                            <Megaphone size={12} />
                          </div>
                          <div className="flex justify-between items-start gap-4">
                            <p className="text-[13px] font-medium text-slate-700 leading-snug">
                              Created new campaign <br /><strong className="text-slate-900 font-bold">"Summer Sale 2024"</strong>
                            </p>
                        ...
                        {/* Event 2 */}
                        <div className="relative">
                          <div className="absolute -left-[30px] top-0 w-6 h-6 rounded-full bg-[#E6F4EA] text-[#137333] flex items-center justify-center ring-4 ring-white z-10">
                            <FileCheck size={12} />
                          </div>
                          <div className="flex justify-between items-start gap-4">
                            <p className="text-[13px] font-medium text-slate-700 leading-snug">
                              Ad creative approved by <br /><strong className="text-slate-900 font-bold">Creative Lead</strong>
                            </p>
                        ...
                        {/* Event 3 */}
                        <div className="relative">
                          <div className="absolute -left-[30px] top-0 w-6 h-6 rounded-full bg-[#FEF7E0] text-[#F29900] flex items-center justify-center ring-4 ring-white z-10">
                            <Coins size={12} />
                          </div>
                          <div className="flex justify-between items-start gap-4">
                            <p className="text-[13px] font-medium text-slate-700 leading-snug">
                              Modified budget for <br /><strong className="text-slate-900 font-bold">"Brand Awareness"</strong>
                            </p>
                        ...
                        {/* Event 4 */}
                        <div className="relative">
                          <div className="absolute -left-[30px] top-0 w-6 h-6 rounded-full bg-[#F3E8FD] text-[#A142F4] flex items-center justify-center ring-4 ring-white z-10">
                            <Users size={12} />
                          </div>
                          <div className="flex justify-between items-start gap-4">
                            <p className="text-[13px] font-medium text-slate-700 leading-snug">
                              Joined <strong className="text-slate-900 font-bold">"Q4 Revenue Strategy"</strong><br /> team
                            </p>
